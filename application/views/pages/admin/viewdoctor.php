                        ...
                        foreach ($doctors as $val) {
                            ...
                            <tr id="rowCount">
                                ...
                                <td class="w3-center">
                                    ...
                                    <a class="btn w3-padding-small" onclick="deleteDoctorDetails(<?php echo $val['doc_id']; ?>)" title="Delete Employee">
                                            ...
                                            <div class="container page_title" style="margin-top: 0px;margin-bottom: 0px;">
                                                <fieldset>
                                                    ...
                                                    <div class="w3-col l12 w3-center">
                                                        <button type="submit" name="submitForm" id="submitForm" class="w3-center w3-hover-text-white btn w3-orange w3-margin-top"> <i class="fa fa-save"></i> Update Doctor </button>
                                                    </div>
                                                </fieldset>
                                                <div id="message"></div>
                                            </div>
